...
The USRP Clients are read from a file defined in Main.h.  The format of this file is ipaddr;port;module; one host per line, ex:

```bash
192.168.1.100;32000;A;
192.168.1.101;32001;B;
```
